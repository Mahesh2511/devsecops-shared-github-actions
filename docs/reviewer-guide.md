...
| **Live failure demo** | [backend-sample PR #1](https://github.com/Mahesh2511/backend-sample/pull/1): check ❌, build skipped, merge **BLOCKED** |
| **Live fix demo** | [frontend-sample PR #1](https://github.com/Mahesh2511/frontend-sample/pull/1): commit 1 ❌, commit 2 ✅ with the build running |
...
| Framework CI on GitHub | Unit tests, 11 PR-check scenarios and 2 build-action runs, all ✅ |
| End-to-end on GitHub | Backend and frontend on `main` ✅. Backend mismatch ❌, build skipped, merge blocked. Frontend malformed ❌ → fixed ✅ |
